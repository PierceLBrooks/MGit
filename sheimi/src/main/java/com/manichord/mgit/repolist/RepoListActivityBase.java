...
public abstract class RepoListActivityBase extends SheimiFragmentActivity {
    protected ActivityMainBinding getBinding() {
        return binding;
    }

    protected abstract void hideCloneView();
    protected abstract String getResultPath();
    protected abstract String getFromPath();
    protected abstract Class<?> getRepoDetailActivityClass();
    protected abstract Class<?> getImportRepositoryActivityClass();
    protected abstract Class<?> getUserSettingsActivityClass();
    protected abstract SheimiDialogFragment getImportLocalRepoDialog();
        ...
        if (uri != null) {
            ...
            if (mRemoteRepoUrl != null) {
                ...
                if (repositoriesWithSameRemote.size() > 0) {
                    ...
                    Intent intent = new Intent(mContext, getRepoDetailActivityClass());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_new) {
            ...
            intent = new Intent(this, getImportRepositoryActivityClass());
            startActivityForResult(intent, REQUEST_IMPORT_REPO);
            forwardTransition();
            return true;
        } else if (item.getItemId() == R.id.action_settings) {
            intent = new Intent(this, getUserSettingsActivityClass());
            startActivity(intent);
            return true;
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case REQUEST_IMPORT_REPO:
                final String path = data.getExtras().getString(getResultPath());
                ...
                builder.setPositiveButton(R.string.label_import,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(
                                ...
                                args.putString(getFromPath(), path);
                                SheimiDialogFragment rld = getImportLocalRepoDialog();
